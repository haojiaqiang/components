...
@implementation HTDeviceUtilities
static HTDeviceUtilities * _sharedInstance = nil;
...
- (BOOL)iPhonePlus {
    DeviceVersion deviceVersion = [SDiOSVersion deviceVersion];
    DeviceSize deviceSize = [SDiOSVersion deviceSize];
    if(deviceVersion==iPhone6Plus || deviceVersion==iPhone6SPlus || deviceVersion == iPhone7Plus || deviceVersion == iPhone8Plus || deviceSize==Screen5Dot5inch){
        return YES;
    }
    return NO;
}
...
- (BOOL)iPhone6 {
    DeviceVersion deviceVersion = [SDiOSVersion deviceVersion];
    DeviceSize deviceSize = [SDiOSVersion deviceSize];
    if(deviceVersion==iPhone6 || deviceVersion==iPhone6S || deviceVersion == iPhone7 || deviceVersion == iPhone8 || deviceSize==Screen4Dot7inch){
        return YES;
    }
    return NO;
}
...
- (BOOL)ultraRetina {
    return ([self iPhoneX] || [self iPhonePlus]);
}
